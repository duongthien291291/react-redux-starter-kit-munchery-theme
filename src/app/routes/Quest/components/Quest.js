...
//         transform(targets.table, 1000);
//         setTimeout(function () {
//           browserHistory.push('/phase1/quest-info/' + self.props.phase1Questions[index].id);
//         }, 1000);
//       });
//     }
//
...
class Quest extends React.Component {
  ...
  goTo = (index) => {
    browserHistory.push('/phase1/quest-info/' + this.props.phase1Questions[index].id);
  }
    ...
    return (
      <div>
        ...
        <ThreeComponent {...this.props}
                        ...
                        goTo={this.goTo}
                        listObject={this.props.phase1Questions}>
